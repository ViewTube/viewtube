...
export const SearchFilter_Filters = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.musicSearchType !== undefined) {
      SearchFilter_Filters_MusicSearchType.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 17:
          ...
          message.musicSearchType = SearchFilter_Filters_MusicSearchType.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const GetCommentsSectionParams_Params = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.repliesOpts !== undefined) {
      GetCommentsSectionParams_Params_RepliesOptions.encode(
        message.repliesOpts,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.repliesOpts = GetCommentsSectionParams_Params_RepliesOptions.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const GetCommentsSectionParams_Params_RepliesOptions = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.unkopts !== undefined) {
      GetCommentsSectionParams_Params_RepliesOptions_UnkOpts.encode(
        message.unkopts,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.unkopts = GetCommentsSectionParams_Params_RepliesOptions_UnkOpts.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const PeformCommentActionParams = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.translateCommentParams !== undefined) {
      PeformCommentActionParams_TranslateCommentParams.encode(
...
export const PeformCommentActionParams_TranslateCommentParams = {
  encode(message, writer = new BinaryWriter()) {
    if (message.params !== undefined) {
      PeformCommentActionParams_TranslateCommentParams_Params.encode(
        message.params,
        writer.uint32(26).fork()
      ).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3:
          ...
          message.params = PeformCommentActionParams_TranslateCommentParams_Params.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const PeformCommentActionParams_TranslateCommentParams_Params = {
  encode(message, writer = new BinaryWriter()) {
    if (message.comment !== undefined) {
      PeformCommentActionParams_TranslateCommentParams_Params_Comment.encode(
        message.comment,
...
export const CommunityPostCommentsParamContainer = {
  encode(message, writer = new BinaryWriter()) {
    if (message.f0 !== undefined) {
      CommunityPostCommentsParamContainer_Container.encode(
        message.f0,
        writer.uint32(641815778).fork()
      ).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 80226972:
          ...
          message.f0 = CommunityPostCommentsParamContainer_Container.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const CommunityPostCommentsParam = {
  encode(message, writer = new BinaryWriter()) {
    ...
    if (message.postContainer !== undefined) {
      CommunityPostCommentsParam_PostContainer.encode(
    ...
    if (message.commentDataContainer !== undefined) {
      CommunityPostCommentsParam_CommentDataContainer.encode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 25:
          ...
          message.postContainer = CommunityPostCommentsParam_PostContainer.decode(
            reader,
            reader.uint32()
          );
          continue;
...
export const CommunityPostCommentsParam_CommentDataContainer = {
  encode(message, writer = new BinaryWriter()) {
    if (message.commentData !== undefined) {
      CommunityPostCommentsParam_CommentDataContainer_CommentData.encode(
        message.commentData,
        writer.uint32(34).fork()
      ).join();
    }
