...
export class ChannelMapper {
  static mapChannel(source: any, aboutSource: any): ChannelDto {
    ...
    const microformatData = source.microformat;
    ...
    const authorBanners = this.mapBanners(header.banner.thumbnails);
    const authorThumbnails = header.avatar.thumbnails;
    ...
    const paid = false;
    const channelLinks = this.mapChannelLinks(
    ...
    const subCount = this.parseAbbreviatedNumber(
