export default {
  inserted(el, binding) {
    ...
    Array.from(div.getElementsByTagName('a')).forEach(
      (element, index) => {
        ...
        if (
          div.getElementsByTagName('a')[index] !== undefined
        ) {
          div.getElementsByTagName('a')[
            index
          ].href = newHrefUrl;
          div
            ...
            [index].removeAttribute('data-url');
          div
            .getElementsByTagName('a')
            [index].removeAttribute(
              'data-target-new-window'
            );
          div
            .getElementsByTagName('a')
            [index].removeAttribute('data-sessionlink');
          div
            .getElementsByTagName('a')
