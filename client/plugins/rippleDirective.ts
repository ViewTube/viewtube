export default defineNuxtPlugin(nuxtApp => {
  const rippleStart = (e: any) => {
    const rippleContainer = getRippleContainer(e.target);
    if (
  ...
  const getRippleContainer = (el: any) => {
